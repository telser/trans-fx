...
instance
  ...
  ) => MonadSimpleSQLite mark (TeletypeTT mark1 t m)
  where
    simpleSQLiteOpen
      :: String
      -> TeletypeTT mark1 t m (mark SQLite.Connection)
